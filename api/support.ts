...
import { uploadChatAttachment } from './messagingUpload';
...
export function useHelpArticlesQuery(filter: { category?: string; q?: string } = {}) {
  return useQuery({
...
// ── Support tickets ──────────────────────────────────────────────────────
export function useSupportTicketsQuery(filter: { status?: string; type?: string; category?: string } = {}) {
  return useQuery({
