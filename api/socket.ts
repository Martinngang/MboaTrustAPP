...
import { firebaseConfigured, getCurrentIdToken } from './firebaseAuth';
...
/** Called on logout so the next login (possibly a different account) opens
 * a fresh connection with fresh auth rather than reusing a stale one. */
